...
routers.include_router(authors.router, prefix="/authors", tags=["Authors"])
routers.include_router(books.router, prefix="/books", tags=["Books"])
routers.include_router(cars.router, prefix="/cars", tags=["Cars"])
